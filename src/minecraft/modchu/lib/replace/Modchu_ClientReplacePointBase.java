...
public class Modchu_ClientReplacePointBase {
...
*/
	public static void clientConnect(Object var1) {
		if (isIntegratedServerRunning()) {
			...
			ModchuModel_TextureManagerReplacePoint.instance.initTextureList(true);
		} else {
			//Debug("Remortmode: ClearTextureList.");
			ModchuModel_TextureManagerReplacePoint.instance.initTextureList(false);
		}
	}
/*
...
*/
	...
	public static void renderArrowsStuckInEntity(EntityLivingBase par1EntityLiving, float par2,
			Render pRender, Modchu_ModelBase pModel) {
		...
		if (lacount > 0) {
			...
			for (int var6 = 0; var6 < lacount; ++var6) {
				...
				Modchu_ModelBoxBaseBase var8 = (Modchu_ModelBoxBaseBase) var7.cubeList.get(lrand.nextInt(var7.cubeList.size()));
