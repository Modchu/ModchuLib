...
public class Modchu_RenderLiving extends RenderLiving implements Modchu_IRenderLiving {
	...
	public Modchu_RenderLiving(Class masterClass, Modchu_ModelBase model, float f) {
		super(model, f);
		Object instance = Modchu_Reflect.newInstance(masterClass, new Class[]{ Modchu_IRenderLiving.class, Object[].class }, new Object[]{ this, new Object[]{ model, f } });
		Modchu_Debug.mDebug("Modchu_RenderLiving init instance="+instance);
		master = instance instanceof Modchu_IRenderLivingMaster ? (Modchu_IRenderLivingMaster) instance : null;
		Modchu_Debug.mDebug("Modchu_RenderLiving init master="+master);
