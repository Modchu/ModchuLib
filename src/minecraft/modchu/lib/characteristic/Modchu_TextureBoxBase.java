...
public class Modchu_TextureBoxBase extends Modchu_TextureBoxBaseBase {
	...
	public void setModels(String pModelName, MultiModelBaseBiped[] pModels, MultiModelBaseBiped[] pDefModels) {
		...
		isUpdateSize = (models != null
				&& models.length > 0
				&& models[0] != null) ? Modchu_EntityCapsHelper.getCapsValueBoolean(models[0], ModchuModel_IEntityCaps.caps_isUpdateSize) : false;
	...
	public Object getArmorTextureName(int pIndex, Object itemStack) {
		...
		return getArmorTextureName(pIndex, Modchu_TextureManagerBase.armorFilenamePrefix[Modchu_AS.getInt(Modchu_AS.itemArmorRenderIndex, item)], l);
	}
