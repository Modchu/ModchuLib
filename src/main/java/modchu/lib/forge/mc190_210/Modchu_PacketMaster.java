...
import modchu.lib.forge.mc180_210.Modchu_PacketHandler;
...
public class Modchu_PacketMaster implements Modchu_IPacketMaster {
	...
	public void sendToAll(Object[] o, String channelName, Object world) {
		...
		if (!b) {
			...
			Modchu_PacketHandler packetHander = getPacketHander(channelName);
			if (packetHander != null); else return;
			Modchu_Reflect.invokeMethod(packetHander.modInstance.getClass(), "onPacketData", new Class[]{ LinkedList.class, Object.class, String.class }, packetHander.modInstance, new Object[]{ Modchu_Main.objectArrayToLinkedList(o), Modchu_AS.get(Modchu_AS.minecraftThePlayer), channelName });
		}
	}
