...
public abstract class Modchu_BlockContainer extends BlockContainer implements Modchu_IBlockContainer {
	...
	@Override
	public boolean superAddDestroyEffects(Object world, int x, int y, int z, int meta, Object particleManager) {
		return false;
	}
	...
	@Override
	public boolean superAddHitEffects(Object world, Object movingObjectPosition, Object particleManager) {
		return false;
	}
	...
	public boolean superRemovedByPlayer(Object world, Object entityPlayer, int x, int y, int z, boolean willHarvest) {
		return super.removedByPlayer(getDefaultState(), (World) world, new BlockPos(x, y, z), (EntityPlayer) entityPlayer, willHarvest);
	}
	...
	public boolean superDoesSideBlockRendering(Object iBlockAccess, Object blockPos, Object enumFacing) {
		return super.doesSideBlockRendering(getDefaultState(), (IBlockAccess) iBlockAccess, (BlockPos) blockPos, (EnumFacing) enumFacing);
	}
