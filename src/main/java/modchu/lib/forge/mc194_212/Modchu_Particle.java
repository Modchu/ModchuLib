...
public abstract class Modchu_Particle extends Particle implements Modchu_IParticle {
	...
	@Override
	public Particle multiplyVelocity(float par1) {
		return (Particle) (master != null ? master.multiplyVelocity(par1) : super.multiplyVelocity(par1));
	}

	@Override
	public Particle superMultiplyVelocity(float par1) {
		return super.multiplyVelocity(par1);
	}

	@Override
	public Particle multipleParticleScaleBy(float par1) {
		return (Particle) (master != null ? master.multipleParticleScaleBy(par1) : super.multipleParticleScaleBy(par1));
	}

	@Override
	public Particle superMultipleParticleScaleBy(float par1) {
	...
	public boolean isTransparent() {
		return master != null ? master.isTransparent() : super.isTransparent();
	}
