...
public class Modchu_EntityMoveHelper extends EntityMoveHelper implements Modchu_IEntityMoveHelper {
	...
	public float getSpeed() {
		return master != null ? Modchu_CastHelper.Float(master.getSpeed(), 0.0F, false) : super.getSpeed();
	}
	...
	@Override
	public void setMoveTo(double x, double y, double z, float speedIn) {
	...
	public void superSetMoveTo(double x, double y, double z, double speedIn) {
		super.setMoveTo(x, y, z, Modchu_CastHelper.Float(speedIn, 0.0F, false));
	}
