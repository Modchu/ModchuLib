...
public class Modchu_EntityPlayer extends EntityPlayer implements Modchu_IEntityPlayer {
	...
	public boolean attackEntityFrom(Entity var1, DamageSource par1DamageSource, int par2) {
		return master != null ? master.attackEntityFrom(var1, par2) : false;
	}
	...
	public int getMaxHealth() {
		return Modchu_CastHelper.Int(supergetMaxHealth());
	}
	...
	public int getHealth() {
		return Modchu_CastHelper.Int(master != null ? master.getHealth() : super.getHealth());
	}

	@Override
	public float supergetHealth() {
		return Modchu_CastHelper.Float(super.getHealth());
	}
	...
	public boolean superattackEntityFrom(Object damageSource, float par2) {
		return super.attackEntityFrom((DamageSource) damageSource, Modchu_CastHelper.Int(par2));
	}
	...
	public void superdamageArmor(float par1) {
		super.damageArmor(Modchu_CastHelper.Int(par1));
	}
	...
	public void superheal(float par1) {
		super.heal(Modchu_CastHelper.Int(par1));
	}

	@Override
	public void supersetHealth(float par1) {
		super.setEntityHealth(Modchu_CastHelper.Int(par1));
	}
	...
	public void superknockBack(Object entity, float par2, double par3, double par5) {
		super.knockBack((Entity) entity, Modchu_CastHelper.Int(par2), par3, par5);
	}
	...
	public Object superapplyArmorCalculations(Object damageSource, float par2) {
		return super.applyArmorCalculations((DamageSource) damageSource, Modchu_CastHelper.Int(par2));
	}

	@Override
	public Object superapplyPotionDamageCalculations(Object damageSource, float par2) {
		return super.applyPotionDamageCalculations((DamageSource) damageSource, Modchu_CastHelper.Int(par2));
	}
