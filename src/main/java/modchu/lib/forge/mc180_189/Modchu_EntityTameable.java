...
*/
	...
	public void superOnLivingUpdate() {
		//Modchu_Debug.mDebug("Modchu_EntityTameable superOnLivingUpdate");
	...
	public void superSetPathToEntity(Object pathEntity) {
		getNavigator().setPath((PathEntity) pathEntity, getEntityAttribute(SharedMonsterAttributes.movementSpeed).getAttributeValue());
	}
	...
	public void fall(float par1) {
		if (master != null) master.fall(par1, 1.0F);
		else super.fall(par1, 1.0F);
	}
	...
	public boolean isEntityInvulnerable() {
		return master != null ? master.isEntityInvulnerable() : super.isEntityInvulnerable(DamageSource.fall);
	}
	...
	public float getExplosionResistance(Explosion explosion, World world, int p_145772_3_, int p_145772_4_, int p_145772_5_, IBlockState block) {
		return master != null ? master.getExplosionResistance(explosion, world, p_145772_3_, p_145772_4_) : super.getExplosionResistance(explosion, world, (BlockPos) Modchu_AS.get(Modchu_AS.newBlockPos, p_145772_3_, p_145772_4_, p_145772_5_), block);
	}
	...
	public void superSetCurrentItemOrArmor(Object p_70062_1_, Object itemStack) {
		super.setCurrentItemOrArmor((Integer) p_70062_1_, (ItemStack) itemStack);
	}
	...
	public void superOnUpdate() {
		//Modchu_Debug.mDebug("Modchu_EntityTameable superOnUpdate");
		super.onUpdate();
	}
