...
public class Modchu_EntityPlayer extends EntityPlayer implements Modchu_IEntityPlayer {
	...
	private boolean debugEntityInitFlag;
	...
	public Modchu_EntityPlayer(HashMap<String, Object> map) {
		...
		if (master != null); else Modchu_Debug.lDebug("Modchu_EntityPlayer init master == null !!");
	}
	...
	public void setHealth(float par1) {
		if (!debugEntityInitFlag) {
			String ss = "Modchu_EntityPlayer setHealth !debugEntityInitFlag error !!";
