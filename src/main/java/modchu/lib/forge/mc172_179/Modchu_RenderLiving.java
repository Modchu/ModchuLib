...
public class Modchu_RenderLiving extends RenderLiving implements Modchu_IRenderLiving {
	...
	@Override
	public void func_147906_a(Entity entity, String str, double x, double y, double z, int maxDistance) {
		if (master != null) master.renderLivingLabel(entity, str, x, y, z, maxDistance);
		else super.func_147906_a(entity, str, x, y, z, maxDistance);
	}

	@Override
	public void superRenderLivingLabel(Object entity, String str, double x, double y, double z, int maxDistance) {
		super.func_147906_a((Entity) entity, str, x, y, z, maxDistance);
	}
	// 190~
	...
	public boolean func_110813_b(EntityLiving entityLiving) {
		return master != null ? master.canRenderName(entityLiving) : super.func_110813_b(entityLiving);
	}

	@Override
	public boolean superCanRenderName(Object entityLiving) {
		return super.func_110813_b((EntityLiving) entityLiving);
	}
	...
	public void func_110827_b(EntityLiving entityLiving, double x, double y, double z, float entityYaw, float partialTicks) {
	...
	public boolean isStaticEntity() {
		return master != null ? master.isStaticEntity() : super.isStaticEntity();
	}
