...
public abstract class Modchu_Item extends modchu.lib.forge.mc190_212.Modchu_Item implements Modchu_IItem {
	...
	public EnumActionResult onItemUse(EntityPlayer entityPlayer, World world, BlockPos blockPos, EnumHand enumHand, EnumFacing enumFacing, float f, float f1, float f2) {
		return (EnumActionResult) (master != null ? master.onItemUse(null, entityPlayer, world, blockPos, enumHand, enumFacing, f, f1, f2) : super.onItemUse(entityPlayer, world, blockPos, enumHand, enumFacing, f, f1, f2));
	}
