...
public abstract class Modchu_ItemFood extends modchu.lib.forge.mc190_212.Modchu_ItemFood implements Modchu_IItemFood {
	...
	@Override
	public EnumActionResult onItemUse(EntityPlayer entityPlayer, World world, BlockPos blockPos, EnumHand enumHand, EnumFacing enumFacing, float f, float f1, float f2) {
		return (EnumActionResult) (master != null ? master.onItemUse(entityPlayer.getHeldItem(enumHand), entityPlayer, world, blockPos, enumHand, enumFacing, f, f1, f2) : super.onItemUse(entityPlayer, world, blockPos, enumHand, enumFacing, f, f1, f2));
	}
	...
	public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer entityPlayer, EnumHand enumHand) {
		return (ActionResult<ItemStack>) (master != null ? master.onItemRightClick(entityPlayer.getHeldItem(enumHand), world, entityPlayer, enumHand) : super.onItemRightClick(world, entityPlayer, enumHand));
	}
