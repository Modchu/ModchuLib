...
public abstract class Modchu_InventoryPlayer extends InventoryPlayer implements Modchu_IInventoryPlayer {
	...
	public void pickItem(int index) {
		if (master != null) master.pickItem(index);
		else super.pickItem(index);
	}
	...
	public int getSlotFor(ItemStack itemStack) {
		return master != null ? master.getSlotFor(itemStack) : super.getSlotFor(itemStack);
	}

	@Override
	public int superGetSlotFor(Object itemStack) {
		return super.getSlotFor((ItemStack) itemStack);
	}

	@Override
	public void deleteStack(ItemStack itemStack) {
		if (master != null) master.deleteStack(itemStack);
		else super.deleteStack(itemStack);
	}

	@Override
	public void superDeleteStack(Object itemStack) {
		super.deleteStack((ItemStack) itemStack);
	}

	@Override
	public float getStrVsBlock(IBlockState iBlockState) {
		return master != null ? master.getStrVsBlock(iBlockState) : super.getStrVsBlock(iBlockState);
	}

	@Override
	public float superGetStrVsBlock(Object iBlockState) {
		return super.getStrVsBlock((IBlockState) iBlockState);
	}
