...
public class Modchu_EntityTameable extends Modchu_EntityTameableB implements Modchu_IEntityTameable {
	...
	public EntityLivingBase superGetOwner() {
		return (EntityLivingBase) super.getOwner();
	}
	...
	public boolean verifyExplosion(Explosion explosion, World world, BlockPos blockPos, IBlockState iBlockState, float f) {
		return master != null ? master.verifyExplosion(explosion, world, blockPos, iBlockState, f) : super.verifyExplosion(explosion, world, blockPos, iBlockState, f);
	}

	@Override
	public boolean superVerifyExplosion(Object explosion, Object world, Object blockPos, Object iBlockState, float f) {
		return super.verifyExplosion((Explosion) explosion, (World) world, (BlockPos) blockPos, (IBlockState) iBlockState, f);
	}
