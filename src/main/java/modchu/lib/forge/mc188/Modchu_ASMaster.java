...
*/
	...
	public void tessellatorStartDrawing(Object tessellator, int i) {
		String s = "Modchu_ASMaster tessellatorStartDrawing vertexFormat null error !!";
		Modchu_Main.setRuntimeException(s);
		//tessellatorStartDrawing(tessellator, i, DefaultVertexFormats.field_181705_e);
	}
	...
	public void tessellatorStartDrawingQuads(Object tessellator) {
		String s = "Modchu_ASMaster tessellatorStartDrawingQuads vertexFormat null error !!";
		Modchu_Main.setRuntimeException(s);
		//tessellatorStartDrawing(tessellator, 7, DefaultVertexFormats.field_181703_c);
	}
