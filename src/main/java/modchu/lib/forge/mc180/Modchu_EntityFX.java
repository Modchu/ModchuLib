...
import modchu.lib.Modchu_IEntityFX;
import modchu.lib.Modchu_IEntityFXMaster;
...
public class Modchu_EntityFX extends EntityFX implements Modchu_IEntityFX {
	public Modchu_IEntityFXMaster master;

	public Modchu_EntityFX(HashMap<String, Object> map) {
		...
		master = instance instanceof Modchu_IEntityFXMaster ? (Modchu_IEntityFXMaster) instance : null;
	}
	...
	public void func_180435_a(TextureAtlasSprite textureAtlasSprite) {
		...
		else super.func_180435_a(textureAtlasSprite);
	}

	@Override
	public void superSetParticleIcon(Object textureAtlasSprite) {
		super.func_180435_a((TextureAtlasSprite) textureAtlasSprite);
	}

	@Override
	public void func_180434_a(WorldRenderer tessellator, Entity entity, float par2, float par3, float par4, float par5, float par6, float par7) {
		if (master != null) master.renderParticle(tessellator, entity, par2, par3, par4, par5, par6, par7);
		else super.func_180434_a(tessellator, entity, par2, par3, par4, par5, par6, par7);
	}
	...
	public void superRenderParticle(Object tessellator, Object entity, float par2, float par3, float par4, float par5, float par6, float par7) {
		super.func_180434_a((WorldRenderer) tessellator, (Entity) entity, par2, par3, par4, par5, par6, par7);
	}

	@Override
	protected void func_180433_a(double par1, boolean par3, Block block, BlockPos blockPos) {
		if (master != null) master.updateFallState(par1, par3, block, blockPos);
		else super.func_180433_a(par1, par3, block, blockPos);
	}

	@Override
	public void superUpdateFallState(double par1, boolean par3, Object block, Object blockPos) {
		super.func_180433_a(par1, par3, (Block) block, (BlockPos) blockPos);
	}
	...
	@Override
	public void func_180426_a(double par1, double par3, double par5, float par7, float par8, int par9, boolean b) {
		if (master != null) master.setPositionAndRotation2(par1, par3, par5, par7, par8, par9, b);
		else super.func_180426_a(par1, par3, par5, par7, par8, par9, b);
	}

	@Override
	public void superSetPositionAndRotation2(double par1, double par3, double par5, float par7, float par8, int par9, boolean b) {
		super.func_180426_a(par1, par3, par5, par7, par8, par9, b);
	}
	...
	@Override
	public boolean func_174816_a(Explosion explosion, World world, BlockPos blockPos, IBlockState iBlockState, float par7) {
		return master != null ? master.shouldExplodeBlock(explosion, world, blockPos, iBlockState, par7) : super.func_174816_a(explosion, world, blockPos, iBlockState, par7);
	}

	@Override
	public boolean superShouldExplodeBlock(Object explosion, Object world, Object blockPos, Object iBlockState, float par7) {
		return super.func_174816_a((Explosion) explosion, (World) world, (BlockPos) blockPos, (IBlockState)iBlockState, par7);
	}
	// ~179
	@Override
