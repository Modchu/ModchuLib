...
public class Modchu_BlockContainer extends BlockContainer implements Modchu_IBlockContainer {
	...
	public Object superCreateNewTileEntity(Object world, int i) {
		return superCreateNewTileEntity(world);
	}
	...
	@Override
	public boolean isLadder(World world, int x, int y, int z, EntityLivingBase entityLivingBase) {
	...
	public boolean superIsLadder(Object world, int x, int y, int z, Object entityLivingBase) {
		return super.isLadder((World) world, x, y, z, (EntityLivingBase) entityLivingBase);
	}
	...
	@Override
	public boolean isBed(World world, int x, int y, int z, EntityLivingBase entityLivingBase) {
	...
	public boolean superIsBed(Object world, int x, int y, int z, Object entityLivingBase) {
		return super.isBed((World) world, x, y, z, (EntityLivingBase) entityLivingBase);
	}
	...
	public boolean canEntityDestroy(World world, int x, int y, int z, Entity entity) {
		return master != null ? master.canEntityDestroy(world, x, y, z, entity) : super.canEntityDestroy(world, x, y, z, entity);
	}

	@Override
	public boolean superCanEntityDestroy(Object world, int x, int y, int z, Object entity) {
		return super.canEntityDestroy((World) world, x, y, z, (Entity) entity);
	}
	...
	public int getExpDrop(World world, int data, int enchantmentLevel) {
		return master != null ? master.getExpDrop(world, data, enchantmentLevel) : super.getExpDrop(world, data, enchantmentLevel);
	}

	@Override
	public int superGetExpDrop(Object world, int data, int enchantmentLevel) {
		return super.getExpDrop((World) world, data, enchantmentLevel);
	}

	@Override
	public void onNeighborTileChange(World world, int x, int y, int z, int tileX, int tileY, int tileZ) {
		if (master != null) master.onNeighborChange(world, x, y, z, tileX, tileY, tileZ);
		else super.onNeighborTileChange(world, x, y, z, tileX, tileY, tileZ);
	}
	...
	public boolean shouldCheckWeakPower(World world, int x, int y, int z, int side) {
		return master != null ? master.shouldCheckWeakPower(world, x, y, z, side) : super.shouldCheckWeakPower(world, x, y, z, side);
	}

	@Override
	public boolean superShouldCheckWeakPower(Object world, int x, int y, int z, int side) {
		return super.shouldCheckWeakPower((World) world, x, y, z, side);
	}
	// ~164
	@Override
	...
	public boolean weakTileChanges() {
		return master != null ? master.weakTileChanges() : super.weakTileChanges();
	}
	...
	public float getFilledPercentage(World world, int x, int y, int z) {
		return master != null ? master.getFilledPercentage(world, x, y, z) : super.getFilledPercentage(world, x, y, z);
	}

	@Override
	public float superGetFilledPercentage(Object world, int x, int y, int z) {
		return super.getFilledPercentage((World) world, x, y, z);
	}
