...
public class Modchu_ItemFood extends ItemFood implements Modchu_IItemFood {
	...
	protected RayTraceResult getMovingObjectPositionFromPlayer(World world, EntityPlayer entityPlayer, boolean par3) {
		return (RayTraceResult) (master != null ? master.getMovingObjectPositionFromPlayer(world, entityPlayer, par3) : super.getMovingObjectPositionFromPlayer(world, entityPlayer, par3));
	}
