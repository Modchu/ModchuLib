...
public class Modchu_EntityOtherPlayerMP extends modchu.lib.forge.mc212_220.Modchu_EntityOtherPlayerMP {
	...
	public void func_192022_b(List<IRecipe> p_192022_1_) {
		...
		else super.func_192022_b(p_192022_1_);
	}

	@Override
	public void superFunc_192022_b(List p_192022_1_) {
		super.func_192022_b((List) p_192022_1_);
	}
