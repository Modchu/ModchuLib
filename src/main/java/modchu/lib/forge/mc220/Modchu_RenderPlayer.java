...
public class Modchu_RenderPlayer extends modchu.lib.forge.mc212_220.Modchu_RenderPlayer {
	...
	@Override
	public boolean isVisible(AbstractClientPlayer abstractClientPlayer) {
		return master != null ? master.isVisible(abstractClientPlayer) : super.isVisible(abstractClientPlayer);
	}

	@Override
	public boolean superIsVisible(Object abstractClientPlayer) {
		return super.isVisible((AbstractClientPlayer) abstractClientPlayer);
	}
