...
/*
	...
	// 180~
	@Override
	public void setLightmap(EntityLiving entityLiving, float p_177105_2_) {
		if (master != null) master.setLightmap(entityLiving, p_177105_2_);
		else super.setLightmap(entityLiving, p_177105_2_);
	}

	@Override
	public void superSetLightmap(Object entityLiving, float p_177105_2_) {
		super.setLightmap((EntityLiving) entityLiving, p_177105_2_);
	}
