...
public class Modchu_BlockContainer extends modchu.lib.forge.mc194_210.Modchu_BlockContainer {
	...
	public boolean isVisuallyOpaque(IBlockState iBlockState) {
		return master != null ? master.isVisuallyOpaque(iBlockState) : super.isVisuallyOpaque(iBlockState);
	}
