...
public class Modchu_AllRenderLiving extends modchu.lib.forge.mc190_220.Modchu_AllRenderLiving {
	...
	protected void rotateCorpse(EntityLivingBase entityLivingBase, float p_77043_2_, float p_77043_3_, float p_77043_4_) {
		Modchu_RenderLiving render = (Modchu_RenderLiving) renderMapGet(entityLivingBase);
