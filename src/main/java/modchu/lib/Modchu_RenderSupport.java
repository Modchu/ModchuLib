...
public class Modchu_RenderSupport {
	public static Modchu_RenderSupport instance;
	private static final int displayListsNumber = 2;
	private HashMap<String, Integer> textureMap = new HashMap();
	private HashMap<BufferedImage, Integer> bindBufferedImageMap = new HashMap();
