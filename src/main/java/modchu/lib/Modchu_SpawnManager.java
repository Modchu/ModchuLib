...
public class Modchu_SpawnManager {
	...
	public Object spawnCreature(String spawModchuClassName, HashMap<String, Object> spawnableMap, Object world, double par2, double par4, double par6) {
		...
		try {
			...
			Class EntityFX = !Modchu_Main.isServer ? Modchu_Reflect.loadClass("EntityFX") : null;
			if (EntityFX != null
					&& EntityFX.isInstance(entity)) {
				if (debug) {
					Modchu_Debug.mDebug("Modchu_SpawnManager spawnCreature 3 EntityFX.isInstance");
				...
				if (effectRenderer != null) Modchu_AS.set("EffectRenderer", "addEffect", new Class[]{ EntityFX }, effectRenderer, new Object[]{ entity });
			} else {
