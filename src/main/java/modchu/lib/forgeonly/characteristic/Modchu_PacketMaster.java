...
import modchu.lib.Modchu_IPacket;
...
public class Modchu_PacketMaster implements Modchu_IPacket {
	public ConcurrentHashMap<String, Object> packetModInstanceMap = new ConcurrentHashMap();
	public String modchuChannelName = "Modchu";

	public Modchu_PacketMaster() {
		Modchu_Debug.lDebug("Modchu_PacketMaster init");
	}
		...
		try {
			...
			for (Object o1 : o) {
				if (o1 instanceof Integer) {
					...
					if (debug) Modchu_Debug.lDebug("Modchu_PacketMaster getBytes String o1="+o1);
				}
		...
		try {
			do {
				...
				if (by == Modchu_Packet.packet_Byte) {
					...
					Modchu_Debug.lDebug("Modchu_PacketMaster receivePacketData packet_Byte o="+o);
				} else if (by == Modchu_Packet.packet_Integer) {
					o = Modchu_PacketManager.readInt(input);
					Modchu_Debug.lDebug("Modchu_PacketMaster receivePacketData packet_Integer o="+o);
					...
					returnFlag = false;
					Modchu_Debug.lDebug("Modchu_PacketMaster receivePacketData packet_end");
				}
				if (o != null) {
					Modchu_Debug.lDebug("Modchu_PacketMaster receivePacketData i="+i+" o="+o);
					list.add(o);
				}
				i++;
