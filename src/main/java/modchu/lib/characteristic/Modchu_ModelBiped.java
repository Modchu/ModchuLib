...
public class Modchu_ModelBiped extends ModelBiped {
	public Modchu_IModelBipedMaster master;

	public Modchu_ModelBiped(Class masterClass) {
		Object instance = masterClass != null ? Modchu_Reflect.newInstance(masterClass, new Class[]{ Modchu_ModelBiped.class, Object[].class }, new Object[]{ this, (Object[]) null }) : null;
