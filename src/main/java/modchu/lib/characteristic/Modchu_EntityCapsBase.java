...
public class Modchu_EntityCapsBase implements Modchu_IEntityCapsBase {
	...
	public Object getCapsValue(int pIndex, Object... pArg) {
		...
		case caps_currentArmor:
			return owner != null ? owner.getEquipmentInSlot((Integer)pArg[0] + 1) : null;
		case caps_posX:
...
*/
		case caps_PosBlockMeta:
			return owner != null ? Modchu_AS.get(Modchu_AS.worldGetBlockStateGetBlockMetadata, owner.worldObj, 
					MathHelper.floor_double(owner.posX + (Double)pArg[0]),
					MathHelper.floor_double(owner.posY + (Double)pArg[1]),
					MathHelper.floor_double(owner.posZ + (Double)pArg[2])) : -1;
		case caps_PosBlockAir:
			return owner != null ? Modchu_AS.get(Modchu_AS.worldIsAirBlock, owner.worldObj,
					MathHelper.floor_double(owner.posX + (Double)pArg[0]),
					MathHelper.floor_double(owner.posY + (Double)pArg[1]),
					MathHelper.floor_double(owner.posZ + (Double)pArg[2])) : false;
		case caps_PosBlockLight:
			return owner != null ? Modchu_AS.get(Modchu_AS.worldGetBlockLightValue, owner.worldObj,
					MathHelper.floor_double(owner.posX + (Double)pArg[0]),
					MathHelper.floor_double(owner.posY + (Double)pArg[1]),
					MathHelper.floor_double(owner.posZ + (Double)pArg[2])) : -1;
		case caps_PosBlockPower:
			return owner != null ? Modchu_AS.get(Modchu_AS.worldGetStrongPower, owner.worldObj,
					MathHelper.floor_double(owner.posX + (Double)pArg[0]),
					MathHelper.floor_double(owner.posY + (Double)pArg[1]),
					MathHelper.floor_double(owner.posZ + (Double)pArg[2])) : -1;
