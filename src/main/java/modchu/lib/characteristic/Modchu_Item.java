...
public class Modchu_Item extends Item {
	...
	public Modchu_Item(Class masterClass) {
		super();
		Object instance = Modchu_Reflect.newInstance(masterClass, new Class[]{ Modchu_Item.class, Object[].class }, new Object[]{ this, null });
