...
public class Modchu_EntityCapsBase implements Modchu_IModelCapsReplacePoint {
...
//		caps.put("PosBlock", caps_PosBlock);
	...
	public Modchu_EntityCapsBase(EntityLivingBase pOwner) {
		owner = pOwner;
	}
	...
	public Object getCapsValue(int pIndex, Object... pArg) {
		...
		case caps_isDead:
			return owner.isDead;
		case caps_isJumping:
			return (Boolean)Modchu_Reflect.getFieldObject("EntityLivingBase", "field_70703_bu", "isJumping", owner);
		case caps_isInWeb:
			return (Boolean)Modchu_Reflect.getFieldObject("Entity", "field_70134_J", "isInWeb", owner);
