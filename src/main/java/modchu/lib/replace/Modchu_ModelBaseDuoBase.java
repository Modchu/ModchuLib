 ...
 */
public class Modchu_ModelBaseDuoBase extends Modchu_ModelBaseNihilReplacePoint implements Modchu_IModelBaseModchuModel {

	public Modchu_ModelMultiReplacePoint modelOuter;
	public Modchu_ModelMultiReplacePoint modelInner;
	/**
	 * 部位毎のアーマーテクスチャの指定。
	 * 外側。
	 */
	...
	public Modchu_ModelBaseDuoBase(RendererLivingEntity pRender) {
