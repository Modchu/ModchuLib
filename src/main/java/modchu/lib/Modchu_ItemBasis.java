...
public class Modchu_ItemBasis implements Modchu_IItem {
	public Modchu_Item base;

	public Modchu_ItemBasis(Modchu_Item modchu_Item, Object... o) {
		base = modchu_Item;
	}
	...
	public float func_150893_a(Object itemStack, Object block) {
		return base.superFunc_150893_a(itemStack, block);
	}
	...
	public boolean func_150897_b(Object block) {
		return base.superFunc_150897_b(block);
	}
