...
public class Modchu_EntityFXMasterBasis implements Modchu_IEntityFXMaster {
	public Modchu_IEntityFX base;

	public Modchu_EntityFXMasterBasis(HashMap<String, Object> map) {
		base = (Modchu_IEntityFX) map.get("base");
	}
	...
	public void setPositionAndRotation2(double par1, double par3, double par5, float par7, float par8, int par9, boolean b) {
		base.superSetPositionAndRotation2(par1, par3, par5, par7, par8, par9, b);
	}
	...
	public boolean func_187111_c() {
		return base.superFunc_187111_c();
	}
