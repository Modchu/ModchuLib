...
public class Modchu_EntityPlayer extends EntityPlayer implements Modchu_IEntityPlayer {
	...
	public boolean superattackEntityFrom(Object damageSource, float par2) {
		return super.attackEntityFrom((DamageSource) damageSource, Modchu_CastHelper.Int(par2, 0, false));
	}
	...
	public void superdamageArmor(float par1) {
		super.damageArmor(Modchu_CastHelper.Int(par1, 0, false));
	}
	...
	public void superdamageEntity(Object damageSource, float par2) {
		super.damageEntity((DamageSource) damageSource, Modchu_CastHelper.Int(par2));
	}
	...
	public void superheal(float par1) {
		super.heal(Modchu_CastHelper.Int(par1, 0, false));
	}
	...
	public void superknockBack(Object entity, float par2, double par3, double par5) {
		super.knockBack((Entity) entity, Modchu_CastHelper.Int(par2, 0, false), par3, par5);
	}
	...
	protected int applyArmorCalculations(DamageSource damageSource, int par2) {
		return Modchu_CastHelper.Int((master != null ? master.applyArmorCalculations(damageSource, par2) : super.applyArmorCalculations(damageSource, par2)));
	}

	@Override
	public Object superapplyArmorCalculations(Object damageSource, float par2) {
		return super.applyArmorCalculations((DamageSource) damageSource, Modchu_CastHelper.Int(par2, 0, false));
	}

	@Override
	protected int applyPotionDamageCalculations(DamageSource damageSource, int par2) {
		return Modchu_CastHelper.Int((master != null ? master.applyPotionDamageCalculations(damageSource, par2) : super.applyPotionDamageCalculations(damageSource, par2)));
	}

	@Override
	public Object superapplyPotionDamageCalculations(Object damageSource, float par2) {
		return super.applyPotionDamageCalculations((DamageSource) damageSource, Modchu_CastHelper.Int(par2, 0, false));
	}
...
*/
	...
	public float supergetMaxHealth() {
		return Modchu_CastHelper.Float(supergetMaxHealthInt(), 0.0F, false);
	}
	...
	public boolean supershouldExplodeBlock(Object explosion, Object world, int par3, int par4, int par5, Object par6, float par7) {
		return super.func_96091_a((Explosion) explosion, (World) world, par3, par4, par5, (Integer) par6, par7);
	}
	...
	@Override
	public void superBlockUsingShield(Object entityLiving) {
	}
	...
	public void sendChatToPlayer(String var1) {
		if (master != null) master.sendChatToPlayer(var1);
	}
