...
public class Modchu_Item extends Item implements Modchu_IItem {
	...
	@Override
	public boolean hitEntity(ItemStack itemStack, EntityLiving entityLivingBase, EntityLiving entityLivingBase1) {
	...
	public boolean superHitEntity(Object itemStack, Object entityLivingBase, Object entityLivingBase1) {
		return super.hitEntity((ItemStack) itemStack, (EntityLiving) entityLivingBase, (EntityLiving) entityLivingBase1);
	}

	@Override
	public boolean itemInteractionForEntity(ItemStack itemStack, EntityLiving entityLivingBase) {
		return master != null ? master.itemInteractionForEntity(itemStack, null, entityLivingBase) : super.itemInteractionForEntity(itemStack, entityLivingBase);
	}

	@Override
	public boolean superItemInteractionForEntity(Object itemStack, Object entityPlayer, Object entityLivingBase) {
		return super.itemInteractionForEntity((ItemStack) itemStack, (EntityLiving) entityLivingBase);
	}
	...
	@Override
	public boolean onBlockDestroyed(ItemStack itemStack, World world, int par3, int par4, int par5, int par6, EntityLiving entityLivingBase) {
	...
	public boolean superOnBlockDestroyed(Object itemStack, Object world, int par3, int par4, int par5, int par6, Object entityLivingBase) {
		return super.onBlockDestroyed((ItemStack) itemStack, (World) world, par3, par4, par5, par6, (EntityLiving) entityLivingBase);
	}
...
*/
	...
	public ModelBiped getArmorModel(EntityLiving entityLivingBase, ItemStack itemStack, int armorSlot) {
		return null;
	}
	...
	public boolean onEntitySwing(EntityLiving entityLivingBase, ItemStack itemStack) {
		return false;
	}
	...
	public boolean onBlockDestroyed(ItemStack itemStack, World world, Block block, int p_150894_4_, int p_150894_5_, int p_150894_6_, EntityLiving entityLivingBase) {
		return false;
	}
