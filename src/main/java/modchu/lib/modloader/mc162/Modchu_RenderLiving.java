...
*/
	...
	public void superDoRenderLiving(Object entityLivingBase, double par2, double par4, double par6, float par8, float par9) {
		super.doRenderLiving((EntityLiving) entityLivingBase, par2, par4, par6, par8, par9);
	}
/*
	@Override
...
/*
	...
	protected ResourceLocation getEntityTexture(Entity entity) {
		...
		Object o = master != null ? master.getEntityTexture(entity) : null;
		if (o != null
				&& o instanceof ResourceLocation); else {
			Modchu_Debug.lDebug1("Modchu_RenderLivingBase getEntityTexture null !! entity="+entity);
			Modchu_Debug.lDebug1("Modchu_RenderLivingBase getEntityTexture null !! entity.getClass()="+(entity != null ? entity.getClass() : null));
			return null;
		}
