...
public class Modchu_EntityPlayer extends EntityPlayer implements Modchu_IEntityPlayer {
	...
	public void superapplyEntityAttributes() {
		Map attributesByName = Modchu_AS.getMap("BaseAttributeMap", "attributesByName", func_110140_aT());
		if (!attributesByName.containsKey(SharedMonsterAttributes.field_111267_a.func_111108_a())
				&& !attributesByName.containsKey(SharedMonsterAttributes.field_111266_c.func_111108_a())
				&& !attributesByName.containsKey(SharedMonsterAttributes.field_111263_d.func_111108_a())) super.func_110147_ax();
	}
...
*/
	...
	public int supergetMaxHealthInt() {
		return (int) super.func_110138_aP();
	}
