...
public class Modchu_EntityTameable extends EntityTameable implements Modchu_IEntityTameable {
	...
	private void init() {
		...
		Modchu_EntityHelper.getInstance().setData(this, "maxSpwanCount", maxSpwanCount);
	}
...
*/
	...
	public EntityLivingBase func_110144_aD() {
		return (EntityLivingBase) (master != null ? master.getLastAttackedEntity() : super.func_110144_aD());
	}
	...
	public ChunkCoordinates func_110172_bL() {
		return (ChunkCoordinates) (master != null ? master.func_110172_bL() : super.func_110172_bL());
	}
