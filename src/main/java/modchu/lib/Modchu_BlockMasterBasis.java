...
public class Modchu_BlockMasterBasis implements Modchu_IBlockMaster {
	public Modchu_IBlock base;

	public Modchu_BlockMasterBasis(HashMap<String, Object> map) {
		base = (Modchu_IBlock) map.get("base");
	}
	...
	public int getWeakPower(Object iBlockState, Object iBlockAccess, Object blockPos, Object enumFacing) {
		return base.superGetWeakPower(iBlockState, iBlockAccess, blockPos, enumFacing);
	}
	...
	public int getStrongPower(Object iBlockState, Object iBlockAccess, Object blockPos, Object enumFacing) {
		return base.superGetStrongPower(iBlockState, iBlockAccess, blockPos, enumFacing);
	}
