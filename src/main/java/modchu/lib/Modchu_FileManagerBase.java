...
//			Modchu_Debug.tDebug(String.format("getMincraftFile-file:%s", base.getMinecraftDir().getName()));
	...
	public void copyResourceText(InputStream is, File outFile) {
		...
		try {
			...
			Modchu_Debug.lDebug("Modchu_FileManager copyResourceText load fail.", 2, e);
		}
	}
...
*/
	...
	public List<String> loadFileToList(File file, List list) {
		...
		try {
			...
			Modchu_Debug.lDebug("Modchu_FileManager loadFileToList "+ file.toString() +" load fail.", 2, e);
			e.printStackTrace();
		}
		return null;
	}
	...
	public List<String> bufferedReaderToList(BufferedReader breader, List list) {
		...
		try {
			...
			Modchu_Debug.lDebug("Modchu_FileManager bufferedReaderToList " + breader + " load fail.", 2, e);
			e.printStackTrace();
		} finally {
			try {
	...
	public List<String> inputStreamToList(InputStream is, List list) {
		...
		try {
			...
			Modchu_Debug.lDebug("Modchu_FileManager inputStreamToList " + breader + " load fail.", 2, e);
			//e.printStackTrace();
		} finally {
			try {
				if (breader != null) breader.close();
	...
	public void writerFile(File file, String[] s) {
		...
		try {
			...
			Modchu_Debug.lDebug("Modchu_FileManager writerFile String[] file="+ file.toString() +" file writer fail.", 2, e);
			e.printStackTrace();
		}
	}
	...
	public void writerFile(File file, Map map) {
		...
		try {
			...
			Modchu_Debug.lDebug("Modchu_FileManager writerFile Map file="+ file.toString() +" file writer fail.", 2, e);
			e.printStackTrace();
		 } finally {
			 try {
				 if (bwriter != null) bwriter.close();
