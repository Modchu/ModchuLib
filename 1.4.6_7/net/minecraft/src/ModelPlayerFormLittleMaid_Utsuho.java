...
public class ModelPlayerFormLittleMaid_Utsuho extends ModelPlayerFormLittleMaid_SR2 {
	...
	public ModelPlayerFormLittleMaid_Utsuho()
	{
		this(0.0F);
	}

	public ModelPlayerFormLittleMaid_Utsuho(float f)
	{
		this(f, 0.0F);
	}

	public ModelPlayerFormLittleMaid_Utsuho(float f, float f1)
	{
		// 132deletesuper(f, f1);
//-@-132
		this(f, f1 , 64, 64);
	...
	public ModelPlayerFormLittleMaid_Utsuho(float f, float f1, int i, int j) {
		super(f, f1, i, j);
//@-@132
    ...
    public void settingShowParts() {
    	...
    	if(getPartsSetFlag() == 2) {
    		String s[] = {
    				"eyeR", "eyeL", "Circle1", "Circle2", "Prim",
    				"WingL", "WingR", "Tail2", "Bust", "Ribon",
    				"CS", "Hip", "Ahoge"
    		};
    		setParts(s, k);
    		setPartsSetFlag(3);
    	...
    	if(getShowModelFlag() == 1) {
    		...
    		k++;
    		b = getGuiShowModel(k);
    		Circle1.setVisible(b);
    		k++;
    		b = getGuiShowModel(k);
    		Circle2.setVisible(b);
    		k++;
    		b = getGuiShowModel(k);
    		Prim.setVisible(b);
    		k++;
    		b = getGuiShowModel(k);
    		WingLroot.setVisible(b);
    		WingL2.setVisible(b);
    		WingL3.setVisible(b);
    		WingL4.setVisible(b);
    		WingL5.setVisible(b);
    		...
    		k++;
    		b = getGuiShowModel(k);
    		RibonLU1.setVisible(b);
    		RibonRU1.setVisible(b);
    		RibonRU2.setVisible(b);
    		RibonRU3.setVisible(b);
    		RibonRU4.setVisible(b);
    		RibonRD1.setVisible(b);
    		RibonRD2.setVisible(b);
    		RibonRD3.setVisible(b);
    		RibonLD1.setVisible(b);
    		RibonLD2.setVisible(b);
    		RibonLD3.setVisible(b);
    		k++;
    		b = getGuiShowModel(k);
    		CS1.setVisible(b);
    		CS2.setVisible(b);
	...
	public void actionRelease1() {
		...
		//rightLeg.removeChild(HipR);
		//rightLeg.removeChild(HipL);
