...
public class ModelPlayerFormLittleMaid_Biped extends ModelPlayerFormLittleMaidBaseBiped
{
	...
	public ModelPlayerFormLittleMaid_Biped() {
		this(0.0F);
	}

	public ModelPlayerFormLittleMaid_Biped(float f) {
		this(f, 0.0F);
	}

	public ModelPlayerFormLittleMaid_Biped(float f, float f1) {
		// 132deletesuper(f, f1);
//-@-132
		this(f, f1 , 64, 32);
	}

	public ModelPlayerFormLittleMaid_Biped(float f, float f1, int i, int j) {
		super(f, f1, i, j);
//@-@132
		Arms[0].setRotationPointLM(-0.5F, 7.0F, 0F);
		Arms[1].setRotationPointLM(0.5F, 7.0F, 0F);
	}
...
/*
		if (f > 0.45F) {
			//Modchu_Debug.mDebug("f > 0.45F f="+f);
			f = 1.0F;
		}
		else if (f > 0.0F) {
			//Modchu_Debug.mDebug("f > 0.0F f="+f);
			f = 0.5F;
		}
...
*/
	...
	public void renderLM(Entity entity, float f, float f1, float ticksExisted, float pheadYaw, float pheadPitch, float f5) {
		...
		if (LMM_EntityLittleMaid != null
			...
			renderStabilizer(entity, map, f, f1, ticksExisted, pheadYaw,
					pheadPitch, f5);
		}
	}
