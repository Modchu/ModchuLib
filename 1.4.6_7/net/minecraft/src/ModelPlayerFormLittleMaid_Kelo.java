...
public class ModelPlayerFormLittleMaid_Kelo extends ModelPlayerFormLittleMaid
{
    ...
    public ModelPlayerFormLittleMaid_Kelo()
    {
        this(0.0F);
    }

    public ModelPlayerFormLittleMaid_Kelo(float f)
    {
        this(f, 0.0F);
    }

    public ModelPlayerFormLittleMaid_Kelo(float f, float f1)
    {
		// 132deletesuper(f, f1);
//-@-132
		this(f, f1 , 64, 32);
	...
	public ModelPlayerFormLittleMaid_Kelo(float f, float f1, int i, int j) {
		super(f, f1, i, j);
//@-@132
	}
    ...
    public void action2(Entity entity) {
		...
		ShoesR.setRotationPoint(0.5F, -5.0F, 0.5F);
		ShoesL.setRotationPoint(0.5F, -5.0F, 0.5F);
    	SleeveR.setVisible(false);
    	SleeveL.setVisible(false);
    }
