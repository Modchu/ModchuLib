...
public class ModelPlayerFormLittleMaid_Aokise extends ModelPlayerFormLittleMaid_SR2
{
    ...
    public ModelPlayerFormLittleMaid_Aokise()
    {
        this(0.0F);
    }

    public ModelPlayerFormLittleMaid_Aokise(float f)
    {
        this(f, 0.0F);
    }

    public ModelPlayerFormLittleMaid_Aokise(float f, float f1)
    {
		// 132deletesuper(f, f1);
//-@-132
		this(f, f1 , 64, 64);
	...
	public ModelPlayerFormLittleMaid_Aokise(float f, float f1, int i, int j) {
		super(f, f1, i, j);
//@-@132
	}
    ...
    public void settingShowParts() {
    	...
    	if(getPartsSetFlag() == 2) {
    		String s[] = {
    				"eyeR", "eyeL", "sideR", "sideL", "mune",
    				"long1", "long2", "longSL1", "longSL2", "longSL3",
    				"longSR1", "longSR2", "longSR3", "kamidome1", "ribon1",
    				"ribon2", "ribon3", "ribon4"
    		};
    		setParts(s, k);
    		setPartsSetFlag(3);
    	}
    	...
    	if(getShowModelFlag() == 1) {
    		...
    		k++;
    		b = getGuiShowModel(k);
    		longSL1.setVisible(b);
    		k++;
    		b = getGuiShowModel(k);
    		longSL2.setVisible(b);
    		k++;
    		b = getGuiShowModel(k);
    		longSL3.setVisible(b);
    		k++;
    		b = getGuiShowModel(k);
    		longSR1.setVisible(b);
    		k++;
    		b = getGuiShowModel(k);
    		longSR2.setVisible(b);
    		k++;
    		b = getGuiShowModel(k);
    		longSR3.setVisible(b);
    		k++;
    		b = getGuiShowModel(k);
    		kamidome1.setVisible(b);
    		k++;
    		b = getGuiShowModel(k);
    		ribon1.setVisible(b);
    		k++;
