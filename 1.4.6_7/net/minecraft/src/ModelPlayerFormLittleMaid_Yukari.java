...
public class ModelPlayerFormLittleMaid_Yukari extends ModelPlayerFormLittleMaid_Aug
{
    ...
    public ModelPlayerFormLittleMaid_Yukari()
    {
        this(0.0F);
    }

    public ModelPlayerFormLittleMaid_Yukari(float f)
    {
        this(f, 0.0F);
    }

    public ModelPlayerFormLittleMaid_Yukari(float f, float f1)
    {
		// 132deletesuper(f, f1);
//-@-132
		this(f, f1 , 64, 64);
	...
	public ModelPlayerFormLittleMaid_Yukari(float f, float f1, int i, int j) {
		super(f, f1, i, j);
//@-@132
	}
