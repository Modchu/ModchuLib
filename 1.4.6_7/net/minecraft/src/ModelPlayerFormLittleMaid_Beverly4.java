...
public class ModelPlayerFormLittleMaid_Beverly4 extends ModelPlayerFormLittleMaid_SR2
{
    ...
    public ModelPlayerFormLittleMaid_Beverly4()
    {
    	this(0.0F);
    }

    public ModelPlayerFormLittleMaid_Beverly4(float f)
    {
    	this(f, 0.0F);
    }

    public ModelPlayerFormLittleMaid_Beverly4(float f, float f1)
    {
    	// 132deletesuper(f, f1);
//-@-132
    	this(f, f1 , 64, 64);
    ...
    public ModelPlayerFormLittleMaid_Beverly4(float f, float f1, int i, int j) {
    	super(f, f1, i, j);
//@-@132
    ...
    public void setRotationAnglesLM(float f, float f1, float f2, float f3, float f4, float f5, Entity entity)
    {
    	...
    	if ((onGroundR > -9990F || onGroundL > -9990F) && !getaimedBow() && !getOldwalking()) {
    		...
    		if (onGroundR > 0F) {
    			...
    			float f8 = (float)Math.sin(getOnGround() * 3.141593F) * -(bipedHead.rotateAngleX - 0.7F) * 0.75F;
    			rightArm.rotateAngleX -= (double)f18 + (double)f8;
    			rightArm.rotateAngleY += bipedBody.rotateAngleY * 2.0F;
    			rightArm.rotateAngleZ = (float)Math.sin(getOnGround() * 3.141593F) * -0.4F;
    		}
    		...
    		if (onGroundL > 0F) {
    			...
    			leftArm.rotateAngleZ = (float)Math.sin(getOnGround() * 3.141593F) * -0.4F;
    		}
    	}
    ...
    public void syncModel(ModelPlayerFormLittleMaidBaseBiped model) {
    	if (getRunActionNumber() == 1
    			| getRunActionNumber() == 2) {
    		bipedBody.rotateAngleZ = model.bipedBody.rotateAngleZ;
    		rightArm.rotateAngleZ = model.rightArm.rotateAngleZ;
    		rightArm2.rotateAngleZ = model.rightArm2.rotateAngleZ;
    		rightArmPlus.rotateAngleZ = model.rightArmPlus.rotateAngleZ;
    		rightArmPlus2.rotateAngleZ = model.rightArmPlus2.rotateAngleZ;
    		rightHand.rotateAngleZ = model.rightHand.rotateAngleZ;
    		leftArm.rotateAngleZ = model.leftArm.rotateAngleZ;
    		leftArm2.rotateAngleZ = model.leftArm2.rotateAngleZ;
