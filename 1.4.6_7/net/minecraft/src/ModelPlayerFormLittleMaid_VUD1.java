...
public class ModelPlayerFormLittleMaid_VUD1 extends ModelPlayerFormLittleMaid_Aug
{
    ...
    public ModelPlayerFormLittleMaid_VUD1()
    {
        this(0.0F);
    }

    public ModelPlayerFormLittleMaid_VUD1(float f)
    {
        this(f, 0.0F);
    }

    public ModelPlayerFormLittleMaid_VUD1(float f, float f1)
    {
		// 132deletesuper(f, f1);
//-@-132
		this(f, f1 , 64, 64);
	...
	public ModelPlayerFormLittleMaid_VUD1(float f, float f1, int i, int j) {
		super(f, f1, i, j);
//@-@132
	}
    ...
    public void initModel(float f, float f1) {
    	...
    	Breast2.setRotationPointLM(0.0F, -0.5F, -2F);
    	...
    	Breast3.setRotationPointLM(0.0F, -0.5F, -2F);
