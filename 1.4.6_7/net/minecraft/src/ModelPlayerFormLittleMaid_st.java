...
public class ModelPlayerFormLittleMaid_st extends ModelPlayerFormLittleMaid_SR2
{
    ...
    public ModelPlayerFormLittleMaid_st()
    {
        this(0.0F);
    }

    public ModelPlayerFormLittleMaid_st(float f)
    {
        this(f, 0.0F);
    }

    public ModelPlayerFormLittleMaid_st(float f, float f1)
    {
		// 132deletesuper(f, f1);
//-@-132
		this(f, f1 , 64, 64);
	...
	public ModelPlayerFormLittleMaid_st(float f, float f1, int i, int j) {
		super(f, f1, i, j);
//@-@132
	}
