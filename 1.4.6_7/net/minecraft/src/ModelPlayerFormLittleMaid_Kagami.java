...
public class ModelPlayerFormLittleMaid_Kagami extends ModelPlayerFormLittleMaid_SR2
{
    ...
    public ModelPlayerFormLittleMaid_Kagami()
    {
        this(0.0F);
    }

    public ModelPlayerFormLittleMaid_Kagami(float f)
    {
        this(f, 0.0F);
    }

    public ModelPlayerFormLittleMaid_Kagami(float f, float f1)
    {
		// 132deletesuper(f, f1);
//-@-132
		this(f, f1 , 64, 64);
	...
	public ModelPlayerFormLittleMaid_Kagami(float f, float f1, int i, int j) {
		super(f, f1, i, j);
//@-@132
	}
    ...
    public void settingShowParts() {
    	...
    	if(getPartsSetFlag() == 2) {
    		String s[] = {
    				"eyeR", "eyeL", "tailR", "tailRFA", "tailRBA",
    				"tailRBB", "kamidomeR", "kamidomeRF", "kamidomeRB", "tailL",
    				"kamidomeL", "kamidomeLF", "kamidomeLB", "tailLFA", "tailLBA",
    				"tailLBB"
    		};
    		setParts(s, k);
    		setPartsSetFlag(3);
    	...
    	if(getShowModelFlag() == 1) {
    		...
    		k++;
    		b = getGuiShowModel(k);
    		tailRFA.setVisible(b);
    		k++;
    		b = getGuiShowModel(k);
    		tailRBA.setVisible(b);
    		k++;
    		b = getGuiShowModel(k);
    		tailRBB.setVisible(b);
    		k++;
    		b = getGuiShowModel(k);
    		kamidomeR.setVisible(b);
    		k++;
    		b = getGuiShowModel(k);
    		kamidomeRF.setVisible(b);
    		k++;
    		b = getGuiShowModel(k);
    		kamidomeRB.setVisible(b);
    		k++;
    		b = getGuiShowModel(k);
    		tailL.setVisible(b);
    		k++;
    		...
    		k++;
    		b = getGuiShowModel(k);
    		kamidomeLF.setVisible(b);
    		k++;
    		b = getGuiShowModel(k);
    		kamidomeLB.setVisible(b);
    		k++;
    		b = getGuiShowModel(k);
    		tailLFA.setVisible(b);
    		k++;
    		b = getGuiShowModel(k);
    		tailLBA.setVisible(b);
    		k++;
    		b = getGuiShowModel(k);
    		tailLBB.setVisible(b);
    		setShowModelFlag(2);
    	}
    }
