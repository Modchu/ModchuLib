...
public class ModelPlayerFormLittleMaid_suika extends ModelPlayerFormLittleMaid
{
    ...
    public ModelPlayerFormLittleMaid_suika()
    {
        this(0.0F);
    }

    public ModelPlayerFormLittleMaid_suika(float f)
    {
        this(f, 0.0F);
    }

    public ModelPlayerFormLittleMaid_suika(float f, float f1)
    {
		// 132deletesuper(f, f1);
//-@-132
		this(f, f1 , 64, 32);
	...
	public ModelPlayerFormLittleMaid_suika(float f, float f1, int i, int j) {
		super(f, f1, i, j);
//@-@132
	}
