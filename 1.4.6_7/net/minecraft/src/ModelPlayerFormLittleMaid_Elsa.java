...
public class ModelPlayerFormLittleMaid_Elsa extends ModelPlayerFormLittleMaid_Elsa2 {

    public ModelPlayerFormLittleMaid_Elsa()
    {
        this(0.0F);
    }

    public ModelPlayerFormLittleMaid_Elsa(float f)
    {
        this(f, 0.0F);
    }

    public ModelPlayerFormLittleMaid_Elsa(float f, float f1)
    {
    	// 132deletesuper(f, f1);
//-@-132
    	this(f, f1 , 64, 32);
    ...
    public ModelPlayerFormLittleMaid_Elsa(float f, float f1, int i, int j) {
    	super(f, f1, i, j);
//@-@132
    }
