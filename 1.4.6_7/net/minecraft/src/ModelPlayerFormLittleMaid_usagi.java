...
public class ModelPlayerFormLittleMaid_usagi extends ModelPlayerFormLittleMaid
{
    ...
    public ModelPlayerFormLittleMaid_usagi()
    {
        this(0.0F);
    }

    public ModelPlayerFormLittleMaid_usagi(float f)
    {
        this(f, 0.0F);
    }

    public ModelPlayerFormLittleMaid_usagi(float f, float f1)
    {
		// 132deletesuper(f, f1);
//-@-132
		this(f, f1 , 64, 32);
	...
	public ModelPlayerFormLittleMaid_usagi(float f, float f1, int i, int j) {
		super(f, f1, i, j);
//@-@132
	}
