...
public class ModelPlayerFormLittleMaid_DogAngel2 extends ModelPlayerFormLittleMaid_DogAngel {

	public ModelPlayerFormLittleMaid_DogAngel2()
	{
		this(0.0F);
	}

	public ModelPlayerFormLittleMaid_DogAngel2(float f)
	{
		this(f, 0.0F);
	}

	public ModelPlayerFormLittleMaid_DogAngel2(float f, float f1)
	{
		// 132deletesuper(f, f1);
//-@-132
		this(f, f1 , 64, 64);
	...
	public ModelPlayerFormLittleMaid_DogAngel2(float f, float f1, int i, int j) {
		super(f, f1, i, j);
//@-@132
	}
