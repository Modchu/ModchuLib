...
//@-@132
    ...
    public void showModelSettingReflects() {
    	...
    	indexOfAllSetVisible("ightArm", bipedRightArm.showModel);
    	indexOfAllSetVisible("eftArm", bipedLeftArm.showModel);
    	indexOfAllSetVisible("ightLeg", bipedRightLeg.showModel);
    	indexOfAllSetVisible("eftLeg", bipedLeftLeg.showModel);
    	if (getSkirtFloats()) {
    		SkirtR.setVisible(false);
    		SkirtL.setVisible(false);
    	}
