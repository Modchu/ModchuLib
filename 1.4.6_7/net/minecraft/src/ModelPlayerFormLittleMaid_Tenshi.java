...
public class ModelPlayerFormLittleMaid_Tenshi extends ModelPlayerFormLittleMaid_SR2 {
	...
	public ModelPlayerFormLittleMaid_Tenshi()
	{
		this(0.0F);
	}

	public ModelPlayerFormLittleMaid_Tenshi(float f)
	{
		this(f, 0.0F);
	}

	public ModelPlayerFormLittleMaid_Tenshi(float f, float f1)
	{
		// 132deletesuper(f, f1);
//-@-132
		this(f, f1 , 64, 64);
	...
	public ModelPlayerFormLittleMaid_Tenshi(float f, float f1, int i, int j) {
		super(f, f1, i, j);
//@-@132
