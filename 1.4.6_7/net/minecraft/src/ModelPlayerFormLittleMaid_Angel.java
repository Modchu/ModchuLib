...
public class ModelPlayerFormLittleMaid_Angel extends ModelPlayerFormLittleMaid_SR2 {
	...
	public ModelPlayerFormLittleMaid_Angel()
	{
		this(0.0F);
	}

	public ModelPlayerFormLittleMaid_Angel(float f)
	{
		this(f, 0.0F);
	}

	public ModelPlayerFormLittleMaid_Angel(float f, float f1)
	{
		// 132deletesuper(f, f1);
//-@-132
		this(f, f1 , 64, 64);
	...
	public ModelPlayerFormLittleMaid_Angel(float f, float f1, int i, int j) {
		super(f, f1, i, j);
//@-@132
    ...
    public void settingShowParts() {
    	...
    	if(getPartsSetFlag() == 2) {
    		String s[] = {
    				"eyeR", "eyeL", "ChignonB", "Prim", "WingL",
    				"WingR", "Tail", "Ahoge", "RibonL", "RibonR",
    				"Circle", "Glass"
    		};
    		setParts(s, k);
    		setPartsSetFlag(3);
    ...
    public void showModelSettingReflects(int i) {
    	super.showModelSettingReflects(i);
    	i = getPartsNumber();
    	...
    	b = getGuiShowModel(i);
    	Ribon0.setVisible(b);
    	RibonLU2.setVisible(b);
    	RibonLU3.setVisible(b);
    	RibonLU4.setVisible(b);
