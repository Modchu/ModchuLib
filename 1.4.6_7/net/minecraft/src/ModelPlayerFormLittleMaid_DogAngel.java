...
public class ModelPlayerFormLittleMaid_DogAngel extends ModelPlayerFormLittleMaid_SR2 {
	...
	public ModelPlayerFormLittleMaid_DogAngel()
	{
		this(0.0F);
	}

	public ModelPlayerFormLittleMaid_DogAngel(float f)
	{
		this(f, 0.0F);
	}

	public ModelPlayerFormLittleMaid_DogAngel(float f, float f1)
	{
		// 132deletesuper(f, f1);
//-@-132
		this(f, f1 , 64, 64);
	...
	public ModelPlayerFormLittleMaid_DogAngel(float f, float f1, int i, int j) {
		super(f, f1, i, j);
//@-@132
    ...
    public void settingShowParts() {
    	...
    	if(getPartsSetFlag() == 2) {
    		String s[] = {
    				"eyeR", "eyeL", "Prim", "WingL", "WingR",
    				"SideTailL2", "SideTailR2", "Tail2", "Bust1", "Ahoge"
    		};
    		setParts(s, k);
    		setPartsSetFlag(3);
    	}
    	...
    	if(getShowModelFlag() == 1) {
    		...
    		WingR6.setVisible(b);
    		k++;
    		SideTailL2.setVisible(b);
    		k++;
    		SideTailR2.setVisible(b);
    		k++;
    		Tail2.setVisible(b);
    		k++;
    		Bust1.setVisible(b);
