...
public class Modchu_Config
{
	...
	private static ArrayList<String> failureShowModelList = new ArrayList<String>();
...
*/
	...
	public static HashMap<Integer, String> getConfigShowPartsNemeMap(String s, int i) {
		...
		Object[] textureModel = textureBoxModelsCheck(null, s);
		if (textureModel != null) {
			int i1 = 0;
			switch(i) {
			case 0:
	...
	private static void showPartsSetting(Object model, String s, int i) {
		...
		for (int i1 = 0; i1 < fields.length; i1++) {
			//Modchu_Debug.mDebug("fields["+i1+"].getType() = "+fields[i1].getType());
			Object o;
			try {
	...
	public static HashMap<String, String> getConfigShowPartsRenemeMap(Object model, String s, int i) {
		...
		if (flag
			...
			if (model instanceof MultiModelBaseBiped) {
				...
				renemeMap = (HashMap<String, String>) ((MultiModelBaseBiped) model).getCapsValue(((MultiModelBaseBiped) model).caps_showPartsRenemeMap);
				if (renemeMap != null) {
	...
	public static HashMap<Integer, String> getConfigShowPartsHideMap(Object model, String s, int i) {
		...
		if (flag
			...
			if (model instanceof MultiModelBaseBiped) {
				...
				((MultiModelBaseBiped) model).defaultPartsSettingBefore();
				List<String> hideList = (List<String>) ((MultiModelBaseBiped) model).getCapsValue(((MultiModelBaseBiped) model).caps_showPartsHideList);
				if (hideList != null) {
					hideMap = new HashMap();
	...
	private static HashMap<Integer, String> getShowPartsNemeMap(int i) {
		return (HashMap<Integer, String>) Modchu_Reflect.invokeMethod(mod_PFLM_PlayerFormLittleMaid, "getShowPartsNemeMap", new Class[]{ int.class }, null, new Object[]{ i });
	}

	private static Object getTextureBox(String s) {
		return Modchu_Reflect.invokeMethod(mod_PFLM_PlayerFormLittleMaid, "getTextureBox", new Class[]{ String.class }, null, new Object[]{ s });
	}

	private static Object[] getTextureBoxModels(Object ltb) {
		return (Object[]) Modchu_Reflect.invokeMethod(mod_PFLM_PlayerFormLittleMaid, "getTextureBoxModels", new Class[]{ Object.class }, null, new Object[]{ ltb });
	}

	private static Object[] textureBoxModelsCheck(Object ltb, String s) {
		return (Object[]) Modchu_Reflect.invokeMethod(mod_PFLM_PlayerFormLittleMaid, "textureBoxModelsCheck", new Class[]{ Object.class, String.class }, null, new Object[]{ ltb, s });
	}

	private static Object[] getTextureModels(String s) {
		return (Object[]) Modchu_Reflect.invokeMethod(mod_PFLM_PlayerFormLittleMaid, "getTextureModels", new Class[]{ String.class }, null, new Object[]{ s });
	}
}
