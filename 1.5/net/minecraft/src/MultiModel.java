...
public class MultiModel extends MultiModelBaseBiped {
    ...
    public void skirtFloatsInit(float f, float f1) {
    	...
    	if (Skirt != null) setCapsValue(caps_setVisible, Skirt, false);
    }
    ...
    public void setRotationAnglesLM(float f, float f1, float f2, float f3, float f4, float f5, Entity entity) {
    	...
    	if (!(Boolean) getCapsValue(caps_getFirstPerson)) {
    		...
    		bipedLeftArm.rotateAngleX = MathHelper.cos(f * 0.6662F) * 2.0F * f1
    				* 0.5F;
    		if (!(Boolean) getCapsValue(caps_getIsSneak) && !(Boolean) getCapsValue(caps_getIsRiding) && (Boolean) getCapsValue(caps_getOldwalking)) {
    		...
    		// アイテム持ってるときの腕振りを抑える
    		if (heldItemLeft != 0 && !(Boolean) getCapsValue(caps_getOldwalking)) {
    			bipedLeftArm.rotateAngleX = bipedLeftArm.rotateAngleX * 0.5F
    					- 0.3141593F * (float) heldItemLeft;
    		}
    		if (heldItemRight != 0 && !(Boolean) getCapsValue(caps_getOldwalking)) {
    ...
    public void showAllParts() {
    	// 表示制限を解除してすべての部品を表示
/*
    	setCapsValue(caps_setVisible, bipedHead, true);
    	setCapsValue(caps_setVisible, bipedBody, true);
    	setCapsValue(caps_setVisible, bipedRightArm, true);
    	setCapsValue(caps_setVisible, bipedLeftArm, true);
    	setCapsValue(caps_setVisible, Skirt, true);
    	setCapsValue(caps_setVisible, bipedRightLeg, true);
    	setCapsValue(caps_setVisible, bipedLeftLeg, true);
*/
    }
    ...
    public void showModelSettingReflects() {
    	...
    	if ((Boolean) getCapsValue(caps_getSkirtFloats)) {
    		if (getGuiParts().get("Skirt") != null) setCapsValue(caps_indexOfAllSetVisible, "Skirt");
    	}
    	if ((Boolean) getCapsValue(caps_getSkirtFloats)
    			&& Skirt != null) setCapsValue(caps_setVisible, Skirt, false);
    }
    ...
    public void setArmorSkirtShowModel(boolean b) {
    	if (Skirt != null
    			&& !(Boolean) getCapsValue(caps_getSkirtFloats)) {
    		Skirt.isHidden = !b;
