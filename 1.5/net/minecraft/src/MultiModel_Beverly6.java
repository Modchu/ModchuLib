...
public class MultiModel_Beverly6 extends MultiModel_SR2 {
	...
	public void setRotationAnglesLM(float f, float f1, float f2, float f3, float f4, float f5, Entity entity)
	{
		...
		{
			if ((Boolean) getCapsValue(caps_getIsSneak)) //しゃがみ
			{
				if ((Boolean) getCapsValue(caps_getIsWait))
				{//膝立ち
    ...
    public void setArmorBipedRightLegShowModel(boolean b) {
    	...
    	setCapsValue(caps_setVisible, hemSkirtR1, b);
    	setCapsValue(caps_setVisible, hemSkirtR2, b);
    	rightLeg.isHidden = !b;
    ...
    public void setArmorBipedLeftLegShowModel(boolean b) {
    	...
    	setCapsValue(caps_setVisible, hemSkirtL1, b);
    	setCapsValue(caps_setVisible, hemSkirtL2, b);
    	leftLeg.isHidden = !b;
