...
public class MultiModel_Shion extends MultiModel {
    ...
    public void setRotationAnglesLM(float f, float f1, float f2, float f3, float f4, float f5, Entity entity) {
    	...
    	setCapsValue(caps_setVisible, sodeL, true);
    	setCapsValue(caps_setVisible, sodeR, true);
    	setCapsValue(caps_setVisible, WsodeL, false);
    	setCapsValue(caps_setVisible, WsodeR, false);
    	if((Boolean) getCapsValue(caps_getIsRiding)) {
    		bipedRightLeg.rotateAngleY = 0.0F;
    		bipedLeftLeg.rotateAngleY = 0.0F;
    	}
    	boolean modchuRemodelingModel = (Boolean) getCapsValue(caps_getModchuRemodelingModel);
    	...
    	if((Boolean) getCapsValue(caps_getIsWait) && !(Boolean) getCapsValue(caps_getaimedBow)) {
    		setCapsValue(caps_setVisible, sodeL, false);
    		setCapsValue(caps_setVisible, sodeR, false);
    		setCapsValue(caps_setVisible, WsodeL, true);
    		setCapsValue(caps_setVisible, WsodeR, true);
    	}
