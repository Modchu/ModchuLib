package modchu.lib.lmm.common.mc190_222;
...
public class Modchu_LmrTextureBox extends TextureBox {

	public ModchuModel_TextureBoxBase master;

	public Modchu_LmrTextureBox(ModchuModel_TextureBoxBase textureBox) {
		super();
	...
	public Modchu_LmrTextureBox(ModchuModel_TextureBoxBase textureBox, String pTextureName, String[] pSearch) {
