...
public class Modchu_ItemRendererHD extends ItemRendererHD {
    ...
    public void renderItemInFirstPerson(float f) {
    	...
    	if (var7 != null) {
    		if (var7.itemID == Item.map.shiftedIndex) {
...
*/
            ...
            if (var17 instanceof RenderPlayer) ((RenderPlayer) var17).drawFirstPersonHand();
            else Modchu_Reflect.invokeMethod(var17.getClass(), "drawFirstPersonHand", var17);
            GL11.glPopMatrix();
/*
    	}
*/
    ...
    public void drawFirstPersonHand(Render r, int h)
    {
    	...
    	Modchu_Reflect.invokeMethod(RenderPlayer.class, "b", "drawFirstPersonHand", r);
    	return;
    }
}