...
//    		GL11.glTranslatef(-0.0625F, 0.4375F, 0.0625F);
    		...
    		if (pRealBlock && (item instanceof ItemBlock)) {
    			...
    			if (block instanceof BlockFlower) GL11.glRotatef(12F, 0F, 1F, 0);
    				...
    				if (mod_Modchu_ModchuLib.modchuLibVersion > 124) GL11.glRotatef(180F, 0.0F, 1.0F, 0.0F);
    			}
...
//@-@b173
    ...
    public void renderObject(float par1, EntityLiving pEntityLiving) {
    	...
    	if (showModel) {
    		...
    		if (!(baseModel instanceof MultiModelBaseBiped) || ((MultiModelBaseBiped)baseModel).isRendering) {
