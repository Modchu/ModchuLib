...
*/
    ...
    public static void initNameMap() {
    	String[] s1 = {
    			...
    			"PFLM_ItemRendererHD", "PFLM_GuiOthersPlayerSlot", "PFLM_RenderPlayerAether", "PFLM_EntityPlayerDummy", "PFLM_EntityPlayerSP",
    			"PFLM_EntityPlayerSP2"
    	};
    	String[] s2 = null;
    	if (mod_Modchu_ModchuLib.modchu_Main.isForge) {
    		...
    		case 152:
    			s2 = new String []{
    					"net.minecraft.client.Minecraft", "net.minecraft.entity.player.EntityPlayer", "net.minecraft.entity.EntityLiving", "net.minecraft.client.renderer.entity.RenderLiving", "java.lang.String",
    					...
    					"PFLM_ItemRendererHDV1", "PFLM_GuiOthersPlayerSlotV1", "", "PFLM_EntityPlayerDummyV1", "PFLM_EntityPlayerSPV1",
    	    			"PFLM_EntityPlayerSP2V1"
    			};
    			break;
    		case 162:
    			s2 = new String []{
    					...
    					"PFLM_ItemRendererHDV160", "PFLM_GuiOthersPlayerSlotV160", "PFLM_RenderPlayerAetherV160", "PFLM_EntityPlayerDummyV160", "PFLM_EntityPlayerSPV160",
    	    			"PFLM_EntityPlayerSP2V160"
    			};
    			break;
    		}
    		...
    		case 162:
    			s2 = new String []{
    					...
    					"bij",
    					"PFLM_RenderPlayer2V160", "PFLM_RenderPlayerV160", "PFLM_GuiSmallButtonV160", "PFLM_RenderPlayerDummyV160", "PFLM_ItemRendererV160",
    					"PFLM_ItemRendererHDV160", "PFLM_GuiOthersPlayerSlotV160", "PFLM_RenderPlayerAetherV160", "PFLM_EntityPlayerDummyV160", "PFLM_EntityPlayerSPV1",
    	    			"PFLM_EntityPlayerSP2V160"
    			};
    			break;
    		}
    	...
    	s1 = new String []{
    			...
    			"func_94277_a", "func_110311_f", "field_110316_a", "field_78729_o", "field_78727_a"
    	};
    	switch(mod_Modchu_ModchuLib.modchu_Main.getMinecraftVersion()) {
    	case 152:
    		s2 = new String []{
